...
$mpdf->SetTitle('TempoReal - Checking de mídia | Relatório TV');
...
$mpdf->WriteHTML('
  <div class="all">
    <div class="content">
      <div class="mt-35">
        <h2 class="text-left font-18 color-AFCB07">Relatório TV: Dengue - Abril</h2>
...
$mpdf->Output('temporeal-checking-de-midia-relatorio-tv.pdf', 'I');
